...
<script>
import ImTriangle from './mip-im-item-triangle.vue'

export default {
  components: {
    'mip-im-triangle': ImTriangle
  },
  props: {
    type: {
      type: String,
